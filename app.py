...
def display_priority_list(display_data: list[dict], max_visible: int = 5):
    ...
    for row in visible_data:
        ...
        html_rows.append(f'<tr><td style="padding: 8px; border-bottom: 1px solid #eee; width: 35%;">{lead_name}</td><td style="padding: 8px; border-bottom: 1px solid #eee; width: 12%;">{appt_date}</td><td style="padding: 8px; border-bottom: 1px solid #eee; width: 10%;">{days}</td><td style="padding: 8px; border-bottom: 1px solid #eee; width: 18%;">{locator}</td><td style="padding: 8px; border-bottom: 1px solid #eee; width: 25%;">{zoho_cell}</td></tr>')
